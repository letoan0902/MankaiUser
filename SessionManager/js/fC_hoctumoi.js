...
let selectedLesson =
  JSON.parse(localStorage.getItem("selectedLessonFlashCard")) || {};
...
btnRemember.addEventListener("click", () => {
  ...
  let originalWord = selectedLesson.vocabulary.find(
    (word) => word.id === wordList[index].id
  );
  if (originalWord) {
...
function updateProgress() {
  ...
  let learned = selectedLesson.vocabulary.filter(
